...
issue_type                  65.0% (13/20)   [43-82%]
object_part                 90.0% (18/20)   [70-97%]
claim_status                75.0% (15/20)   [53-89%]
severity                    45.0% (9/20)   [26-66%]
risk_flags                 exact  60.0%  micro-F1 0.81  Hamming 0.50/claim
supporting_image_ids       exact  85.0%  micro-F1 0.89  Hamming 0.20/claim
------------------------------------------------------------
severity (ordinal): exact 45%  within-1 85%  MAE 0.67  QWK 0.49
claim_status macro-F1 0.71  supported:F1=0.80(n=13)  contradicted:F1=0.67(n=5)  not_enough_information:F1=0.67(n=2)
------------------------------------------------------------
OVERALL (mean of 8 fields)  75.6%   [53-89%]
```
...
**within-1 accuracy 85%, MAE 0.67,
QWK 0.49** — i.e. almost every "error" is a single adjacent level.
...
- risk_flags exact-set accuracy **with** history layer: 12/20 (60%); **without** it (visual flags only): 9/20 (45%). The deterministic history layer is responsible for the difference.

## Error analysis (13/20 rows with at least one field error)
...
- row 1 (user_002, car): claim_status: contradicted≠supported; issue_type: crack≠scratch; severity: medium≠low; risk_flags: claim_mismatch≠none
- row 2 (user_004, car): severity: high≠medium
- row 3 (user_007, car): severity: high≠medium
- row 4 (user_005, car): issue_type: none≠scratch; severity: none≠low; risk_flags: damage_not_visible;user_history_risk;manual_review_required≠claim_mismatch;user_history_risk;manual_review_required; supporting_image_ids: img_2≠img_1
...
- row 11 (user_012, laptop): severity: medium≠low; risk_flags: low_light_or_glare≠none
- row 12 (user_018, laptop): severity: high≠medium
- row 14 (user_015, package): claim_status: contradicted≠supported; issue_type: none≠crushed_packaging; severity: none≠medium; risk_flags: damage_not_visible≠none
...
- row 18 (user_033, package): object_part: box≠unknown; evidence_standard_met: false≠true; risk_flags: wrong_object;user_history_risk;manual_review_required≠wrong_object;claim_mismatch;user_history_risk;manual_review_required
...
|---|---|---|
| Billed model calls | 20 | ~44 |
| Local cache hits (free) | 0 | grows on re-runs |
| Images processed | 29 | ~63 |
| Input tokens | 32,173 | ~70,780 |
| Output tokens | 11,404 | ~25,088 |
| Estimated cost (USD) | $0.5471 | ~$0.6018 (Batch API, 50% off) |
| Wall-clock runtime | 154.3s | minutes (async batch) |
